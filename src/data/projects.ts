...
export const projects: Project[] = [
  {
    ...
    name: "SNS",
    mainImg: ["SNSMain.png"],
    imgs: ["SNSMain.png","SNSLogin.png","SNSPost.png","SNSChat.png","SNSInfo.png","SNSDark.png"],
    description: "JWT 인증·실시간 채팅·피드 추천 알고리즘을 갖춘 풀스택 SNS 플랫폼. Socket.IO 기반 양방향 통신과 해시태그 검색까지 직접 설계·구현.",
    url: "https://tomyhasblog.vercel.app",
    gitHub: "https://github.com/tomyhas59/blog",
    features: [
      "JWT AccessToken / RefreshToken 이중 인증 구조 설계",
  ...
  },
  {
    ...
    imgs: ["shopMain.png","shopProductDetail.png","shopProducts.png","shopCart.png"],
    description: "GraphQL API·Firebase 인증을 조합한 Next.js 기반 커머스 플랫폼. Apollo Server 스키마 설계부터 장바구니 상태 관리까지 E2E 구현.",
  ...
  },
  {
    ...
    description: "Java Spring Boot로 RESTful API 서버를 직접 설계·구현하고 React와 연동한 가계부 애플리케이션. JPA 엔티티 설계부터 배포까지 백엔드 전 과정 담당.",
  ...
  },
  {
    ...
    imgs: ["lawmateMain.png"],
    description: "법률 질문·답변, 판례 검색, 변호사 매칭·후기 시스템을 갖춘 법률 서비스 플랫폼. 5인 팀 프로젝트에서 법률 질문·판례·변호사 도메인 3개 파트 전담.",
    url: "",
    gitHub: "",
    teamSize: 5,
    ...
    features: [
      ...
      "변호사 전용 답변 등록, 의뢰인 채택 시 TB_ANSWER.IS_ADOPTED 갱신 및 질문 CLOSED 처리",
      "Oracle TB_PRECEDENT KEYWORD_CSV 기반 판례 키워드·유형 검색 구현",
      "판례 상세 및 Python 유사도 분석 기반 유사 판례 추천 연동",
      "변호사 목록 전문분야 필터·별점순/후기순 정렬 및 페이지네이션",
      "변호사 상세 프로필·Python 집계 별점 분포 차트 React 렌더링",
      "상담 완료(DONE) 건 한정 별점·후기 작성 및 평균 별점 자동 갱신 트리거 연동",
    ],
    stack: {
