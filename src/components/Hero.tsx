...
interface HeroProps { onScrollToProjects: () => void; }
...
const ROLES = ["Backend Developer", "Fullstack Developer", "Spring Boot Engineer"];
    ...
    <section className="hero" id="hero">
      ...
      <div className="hero__content">
        ...
        <h1 className="hero__title">
          <span className="hero__title-name">TomyHas</span>
        ...
        <p className="hero__desc">
          백엔드를 깊이 이해하는 풀스택 개발자입니다.
          <br />
          <strong style={{color:"var(--accent)"}}>Java · Spring Boot · Python</strong>으로 견고한 서버를 설계하고,
          <br />
          <strong style={{color:"var(--accent2)"}}>React · TypeScript</strong>로 서비스 전체를 완성합니다.
        </p>
        ...
        <div className="hero__cta">
          ...
          <a className="btn btn--outline" href="https://github.com/tomyhas59" target="_blank" rel="noreferrer">
      ...
      <div className="hero__scroll">
        <svg width="16" height="24" viewBox="0 0 16 24" fill="none">
          <rect x="1" y="1" width="14" height="22" rx="7" stroke="var(--accent)" strokeWidth="1.5" opacity=".5"/>
