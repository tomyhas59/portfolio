...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const allTags = [
    ...project.stack.backend
      .slice(0, 2)
      .map((t) => ({ label: t, type: "backend" })),
    ...project.stack.frontend
      .slice(0, 2)
      .map((t) => ({ label: t, type: "frontend" })),
    ...project.stack.deploy
      .slice(0, 1)
      .map((t) => ({ label: t, type: "deploy" })),
  ];

  const projectArr = project.description.split(". ");
  ...
  return (
    ...
    >
      <div className="project-card__thumb">
        ...
        {project.teamSize && (
          <span className="project-card__team-badge">
        ...
        <div className="project-card__overlay">
          ...
          {project.url && (
            <a
              className="project-card__overlay-btn project-card__overlay-btn--secondary"
              href={project.url}
              target="_blank"
              rel="noreferrer"
