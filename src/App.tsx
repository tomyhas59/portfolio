  ...
  return (
    <>
      ...
      <div className="cursor" ref={cursorRef}>
        <div className="cursor__dot"  ref={cursorDotRef}  style={{position:"fixed"}} />
        <div className="cursor__ring" ref={cursorRingRef} style={{position:"fixed"}} />
      </div>
      ...
      <footer className="footer">
        <p>© 2025 TomyHas · Built with <span>React</span> & <span>TypeScript</span></p>
      </footer>
    </>
  );
};
